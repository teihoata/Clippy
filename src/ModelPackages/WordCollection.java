...
public class WordCollection extends JFrame implements HotkeyListener, IntellitypeListener {
    ...
    /**
     * Defines the standard behavior for a node. The standard behavior is: <ul>
     * <li> On entry the set of sentences that can be spoken is displayed. <li>
     * On recognition if a tag returned contains the prefix 'dialog_' it
     * indicates that control should transfer to another dialog node. </ul>
     */
    ...
    /**
     * An extension of the standard node behavior for music. This node will add
     * rules to the grammar based upon the contents of the music.txt file. This
     * provides an example of how to extend a grammar directly from code as
     * opposed to writing out a JSGF file.
     */
